      ...
      <Container fluid >
        ...
        <Row className={`${styles.banner}     text-light`} >
          <Col md={12} lg={6} className='text-center ' >
            <img src='../images/me.jpg' className='bgimg-about img-fluid animate__animated animate__rotateInDownLeft' />
            <p className='px-5 text-start mt-4  animate__animated animate__zoomIn'>Hello there! I'm Divya Bagul, a passionate and experienced full-stack developer.<br></br> I have a strong foundation in both front-end and back-end development, and I specialize in creating robust and scalable web applications. I believe in crafting elegant and efficient solutions that not only meet client requirements but also provide a seamless user experience</p>
          </Col>
          <Col md={12} lg={5} className=' mt-5  animate__animated animate__backInRight'>

          

              <p> I am always eager to explore new technologies and frameworks to enhance my development skills. I believe in writing clean and maintainable code, following industry best practices, and staying up-to-date with the latest trends and advancements in web development. <br></br>

                If you have a project or idea that you would like to discuss, please feel free to reach out through the contact form or email provided. I would be thrilled to collaborate and help bring your vision to life.</p>
